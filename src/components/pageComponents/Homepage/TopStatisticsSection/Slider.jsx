        ...
        return (
          <SplideSlide key={slide.id}>
            <div className="slide_wrapper relative flex flex-col items-center">
              ...
              />
              <h2 className="absolute top-[55%] md:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-left text-lg lg:text-5xl lg:leading-1 text-white font-semibold w-[80%] md:w-[80%]">
                {slide.text}
              </h2>
              <div className="absolute top-[10%] flex items-center justify-between w-[80%] !mx-auto">
